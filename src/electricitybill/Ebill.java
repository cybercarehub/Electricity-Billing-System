...
public class Ebill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-869)/2, (screenSize.height-563)/2, 869, 563);
    }// </editor-fold>//GEN-END:initComponents
    String cid;
    double charge, granmount;
    int count;
    ...
    public void print() {
        ...
        jTextArea2.setText(jTextArea2.getText() + "\n");
        jTextArea2.setText(jTextArea2.getText() + "Customer ID : " + cid + "\n");
        jTextArea2.setText(jTextArea2.getText() + "Customer Name : " + cname + "\n");
        jTextArea2.setText(jTextArea2.getText() + "Unit : " + unit + "\n");
        jTextArea2.setText(jTextArea2.getText() + "Amount : " + granmount + "\n");
        jTextArea2.setText(jTextArea2.getText() + "Thank You!");
    }
